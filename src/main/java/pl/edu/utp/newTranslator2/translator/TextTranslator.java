...
public class TextTranslator {
    ...
    public static String translate(String sourceLanguage, String targetLanguage, String text) {
        try {
            ...
            String urlString = "https://translate.yandex.net/api/v1.5/tr/translate?key=trnsl.1.1.20190811T161750Z.e324b11d8a02bfb0.a0b0eccf91cffc38f4eb74253904879fc875c4fd&lang=" + sourceLanguage + "-" + targetLanguage + "&text=" + text;
